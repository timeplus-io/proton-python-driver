...
#define __pyx_kp_u_proton_driver_varint_pyx __pyx_string_tab[1]
...
#define __pyx_n_u_make_varint __pyx_string_tab[12]
#define __pyx_n_u_module __pyx_string_tab[13]
#define __pyx_n_u_name __pyx_string_tab[14]
#define __pyx_n_u_num_buf __pyx_string_tab[15]
#define __pyx_n_u_number __pyx_string_tab[16]
#define __pyx_n_u_pop __pyx_string_tab[17]
#define __pyx_n_u_proton_driver_varint __pyx_string_tab[18]
#define __pyx_n_u_qualname __pyx_string_tab[19]
#define __pyx_n_u_read_one __pyx_string_tab[20]
#define __pyx_n_u_read_varint __pyx_string_tab[21]
#define __pyx_n_u_result __pyx_string_tab[22]
#define __pyx_n_u_set_name __pyx_string_tab[23]
#define __pyx_n_u_setdefault __pyx_string_tab[24]
#define __pyx_n_u_shift __pyx_string_tab[25]
#define __pyx_n_u_test __pyx_string_tab[26]
#define __pyx_n_u_to_write __pyx_string_tab[27]
#define __pyx_n_u_values __pyx_string_tab[28]
#define __pyx_n_u_write __pyx_string_tab[29]
#define __pyx_n_u_write_varint __pyx_string_tab[30]
#define __pyx_kp_b_iso88591_Q_7_A_1_1_1E_A_1E_AXYa __pyx_string_tab[31]
#define __pyx_kp_b_iso88591_Q_7_A_1_1_1E_A_1E_vQ_q __pyx_string_tab[32]
#define __pyx_kp_b_iso88591_q_q_HA_2RvS_2Rq_1 __pyx_string_tab[33]
...
static PyMethodDef __pyx_mdef_13proton_driver_6varint_1make_varint = {"make_varint", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_13proton_driver_6varint_1make_varint, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_13proton_driver_6varint_make_varint};
static PyObject *__pyx_pw_13proton_driver_6varint_1make_varint(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "make_varint", 0) < (0)) __PYX_ERR(0, 5, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 1; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("make_varint", 1, 1, 1, i); __PYX_ERR(0, 5, __pyx_L3_error) }
      }
    ...
    __pyx_v_number = __Pyx_PyLong_As_unsigned_PY_LONG_LONG(values[0]); if (unlikely((__pyx_v_number == (unsigned PY_LONG_LONG)-1) && PyErr_Occurred())) __PYX_ERR(0, 5, __pyx_L3_error)
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("make_varint", 1, 1, 1, __pyx_nargs); __PYX_ERR(0, 5, __pyx_L3_error)
  __pyx_L6_skip:;
...
*/
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_2 = PyBytes_FromStringAndSize(((char *)__pyx_v_num_buf), __pyx_v_i); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 26, __pyx_L1_error)
...
static PyMethodDef __pyx_mdef_13proton_driver_6varint_3write_varint = {"write_varint", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_13proton_driver_6varint_3write_varint, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_13proton_driver_6varint_2write_varint};
static PyObject *__pyx_pw_13proton_driver_6varint_3write_varint(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    PyObject ** const __pyx_pyargnames[] = {&__pyx_mstate_global->__pyx_n_u_number,&__pyx_mstate_global->__pyx_n_u_buf,0};
    const Py_ssize_t __pyx_kwds_len = (__pyx_kwds) ? __Pyx_NumKwargs_FASTCALL(__pyx_kwds) : 0;
    ...
    if (__pyx_kwds_len > 0) {
      ...
      const Py_ssize_t kwd_pos_args = __pyx_nargs;
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "write_varint", 0) < (0)) __PYX_ERR(0, 29, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 2; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("write_varint", 1, 2, 2, i); __PYX_ERR(0, 29, __pyx_L3_error) }
      }
    ...
    __pyx_v_number = __Pyx_PyLong_As_unsigned_PY_LONG_LONG(values[0]); if (unlikely((__pyx_v_number == (unsigned PY_LONG_LONG)-1) && PyErr_Occurred())) __PYX_ERR(0, 29, __pyx_L3_error)
    __pyx_v_buf = values[1];
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("write_varint", 1, 2, 2, __pyx_nargs); __PYX_ERR(0, 29, __pyx_L3_error)
  __pyx_L6_skip:;
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  for (Py_ssize_t __pyx_temp=0; __pyx_temp < (Py_ssize_t)(sizeof(values)/sizeof(values[0])); ++__pyx_temp) {
...
*/
  ...
  __Pyx_INCREF(__pyx_t_3);
  __pyx_t_4 = PyBytes_FromStringAndSize(((char *)__pyx_v_num_buf), __pyx_v_i); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 50, __pyx_L1_error)
...
static PyMethodDef __pyx_mdef_13proton_driver_6varint_5read_varint = {"read_varint", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_13proton_driver_6varint_5read_varint, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_13proton_driver_6varint_4read_varint};
static PyObject *__pyx_pw_13proton_driver_6varint_5read_varint(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      const Py_ssize_t kwd_pos_args = __pyx_nargs;
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "read_varint", 0) < (0)) __PYX_ERR(0, 53, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 1; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("read_varint", 1, 1, 1, i); __PYX_ERR(0, 53, __pyx_L3_error) }
      }
    } else if (unlikely(__pyx_nargs != 1)) {
      goto __pyx_L5_argtuple_error;
    } else {
  ...
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("read_varint", 1, 1, 1, __pyx_nargs); __PYX_ERR(0, 53, __pyx_L3_error)
  __pyx_L6_skip:;
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  for (Py_ssize_t __pyx_temp=0; __pyx_temp < (Py_ssize_t)(sizeof(values)/sizeof(values[0])); ++__pyx_temp) {
 ...
 *     while True:
*/
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_f, __pyx_mstate_global->__pyx_n_u_read_one); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 60, __pyx_L1_error)
...
*/
    ...
    __pyx_t_5 = __Pyx_PyLong_As_unsigned_PY_LONG_LONG(__pyx_t_1); if (unlikely((__pyx_t_5 == (unsigned PY_LONG_LONG)-1) && PyErr_Occurred())) __PYX_ERR(0, 63, __pyx_L1_error)
...
*/
  ...
  /* "proton_driver/varint.pyx":69
 *             break
 * 
 *     return result             # <<<<<<<<<<<<<<
*/
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_PyLong_From_unsigned_PY_LONG_LONG(__pyx_v_result); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 69, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
__Pyx_RefNannySetupContext("PyInit_varint", 0);
 ...
 *     Writes integer of variable length using LEB128.
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_13proton_driver_6varint_1make_varint, 0, __pyx_mstate_global->__pyx_n_u_make_varint, NULL, __pyx_mstate_global->__pyx_n_u_proton_driver_varint, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_make_varint, __pyx_t_2) < (0)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 *     Writes integer of variable length using LEB128.
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_13proton_driver_6varint_3write_varint, 0, __pyx_mstate_global->__pyx_n_u_write_varint, NULL, __pyx_mstate_global->__pyx_n_u_proton_driver_varint, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[1])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 29, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_write_varint, __pyx_t_2) < (0)) __PYX_ERR(0, 29, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 *     Reads integer of variable length using LEB128.
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_13proton_driver_6varint_5read_varint, 0, __pyx_mstate_global->__pyx_n_u_read_varint, NULL, __pyx_mstate_global->__pyx_n_u_proton_driver_varint, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[2])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 53, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_read_varint, __pyx_t_2) < (0)) __PYX_ERR(0, 53, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 7; } index[] = {{1},{24},{20},{18},{3},{18},{1},{8},{1},{13},{5},{8},{11},{10},{8},{7},{6},{3},{20},{12},{8},{11},{6},{12},{10},{5},{8},{8},{6},{5},{12},{82},{86},{66}};
    #if (CYTHON_COMPRESS_STRINGS) == 3 && __PYX_LIMITED_VERSION_HEX >= 0x030e0000 /* compression: zstd (359 bytes) */
const char* const cstring = "(\265/\375`\n\001\355\n\000\006SD-po\016|'\355Uq\235'\255\337\326\337\035\305M\244h#\221m\322\2619R\362*%\350\231K\002\304~}\201\201\311\201Q\203\251Z\0075\0001\0009\000U\364]\315\333\257u\260\373F\221\376k\367\2103\356\"\330v\027\245\353\367\236}\372\215\357\316bN(\216\373\tU\212\354ks%%\371I\233=\277x\343\\\262\004\356\033\034\365\347\277\330\275\372\031\254\243\030)\341R~\221\207\343